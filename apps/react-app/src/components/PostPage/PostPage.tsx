...
function PostPage() {
  return (
    <Container container>
      <BannerContainer item>{/* Activity 1 - Render Banner */}</BannerContainer>
      <DescriptionContainer item>
        <p>{/* Activity 1 - Render post description */}</p>
      </DescriptionContainer>
      <CommentsContainer item>{/* Activity 1 - Render Comments */}</CommentsContainer>
    </Container>
  );
}
